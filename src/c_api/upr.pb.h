...
class Layer
    : public ::google::protobuf::
          Message /* @@protoc_insertion_point(class_definition:upr.Layer) */ {
public:
  Layer();
  virtual ~Layer();
...
#if LANG_CXX11
  Layer(Layer &&from) noexcept : Layer() { *this = ::std::move(from); }
...
class ModelHandle
    : public ::google::protobuf::
          Message /* @@protoc_insertion_point(class_definition:upr.ModelHandle) */
{
public:
  ModelHandle();
  virtual ~ModelHandle();
...
#if LANG_CXX11
  ModelHandle(ModelHandle &&from) noexcept : ModelHandle() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(ModelHandle &a, ModelHandle &b) { a.Swap(&b); }
...
public:
  ...
  ::google::protobuf::RepeatedPtrField<::upr::Layer> *mutable_layers();
  const ::google::protobuf::RepeatedPtrField<::upr::Layer> &layers() const;
...
class Model
    : public ::google::protobuf::
          Message /* @@protoc_insertion_point(class_definition:upr.Model) */ {
public:
  Model();
  virtual ~Model();
...
#if LANG_CXX11
  Model(Model &&from) noexcept : Model() { *this = ::std::move(from); }
...
public:
  ...
  ::google::protobuf::RepeatedPtrField<::upr::ModelHandle> *mutable_models();
...
class ModelRequest
    : public ::google::protobuf::
          Message /* @@protoc_insertion_point(class_definition:upr.ModelRequest) */
{
public:
  ModelRequest();
...
#if LANG_CXX11
  ModelRequest(ModelRequest &&from) noexcept : ModelRequest() {
    *this = ::std::move(from);
  }
...
class Void
    : public ::google::protobuf::
          Message /* @@protoc_insertion_point(class_definition:upr.Void) */ {
public:
  Void();
  virtual ~Void();
...
// int64 byte_count = 3;
inline void Layer::clear_byte_count() { byte_count_ = GOOGLE_LONGLONG(0); }
...
inline ::std::string *Layer::mutable_ipc_handle_path() {
  ...
  return ipc_handle_path_.MutableNoArena(
      &::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string *Layer::release_ipc_handle_path() {
  // @@protoc_insertion_point(field_release:upr.Layer.ipc_handle_path)

  return ipc_handle_path_.ReleaseNoArena(
      &::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void
Layer::set_allocated_ipc_handle_path(::std::string *ipc_handle_path) {
  if (ipc_handle_path != NULL) {

  } else {
  }
  ipc_handle_path_.SetAllocatedNoArena(
      &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ipc_handle_path);
...
// int64 ref_count = 6;
inline void Layer::clear_ref_count() { ref_count_ = GOOGLE_LONGLONG(0); }
...
inline void ModelHandle::set_allocated_model_id(::std::string *model_id) {
  ...
  model_id_.SetAllocatedNoArena(
      &::google::protobuf::internal::GetEmptyStringAlreadyInited(), model_id);
...
// repeated .upr.Layer layers = 4;
inline int ModelHandle::layers_size() const { return layers_.size(); }
inline void ModelHandle::clear_layers() { layers_.Clear(); }
...
// int64 ref_count = 4;
inline void Model::clear_ref_count() { ref_count_ = GOOGLE_LONGLONG(0); }
...
// repeated .upr.ModelHandle models = 5;
inline int Model::models_size() const { return models_.size(); }
inline void Model::clear_models() { models_.Clear(); }
...
inline void ModelRequest::set_allocated_model_name(::std::string *model_name) {
  ...
  model_name_.SetAllocatedNoArena(
      &::google::protobuf::internal::GetEmptyStringAlreadyInited(), model_name);
...
// bool no_cache = 3;
inline void ModelRequest::clear_no_cache() { no_cache_ = false; }
