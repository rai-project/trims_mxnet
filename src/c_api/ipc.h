...
static const auto UPR_SHARING_GRANULARITY   = dmlc::GetEnv("UPR_SHARING_GRANULARITY", "model");
...
static std::map<std::string, size_t> model_internal_memory_usage{
    ...
    {"large_vgg16_896x896_1.0", 3ll * 1024 * 1024 * 1024}, // 14305220944},
    {"large_alexnet_681x681_1.0", 3629523176},
    {"large_vgg16_672x672_1.0", 3ll * 1024 * 1024 * 1024},   // 8171305296},
    {"large_alexnet_908x908_1.0", 3ll * 1024 * 1024 * 1024}, // 6450317776},
