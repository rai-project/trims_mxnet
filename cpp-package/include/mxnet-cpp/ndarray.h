...
public:
  ...
  /*!
   * \return the size of current NDArray, a.k.a. the production of all shape
   * dims
   */
  size_t Size() const;
  /*!
  ...
  int GetDType() const;
  /*!
   * \brief Get the pointer to data (IMPORTANT: The ndarray should not be in
   * GPU) \return the data pointer to the current NDArray
   */
